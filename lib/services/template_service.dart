...
class TemplateService {
  ...
  static Future<TemplateDefinition> load(String template) async {
    ...
    if (!manifest.existsSync()) throw Exception('Template "$template" not found.');
  ...
  static Future<Map<dynamic, dynamic>> _loadSection(
    ...
    if (!file.existsSync()) throw Exception('Missing template file "$relative" for section "$section".');
